        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            emailjs
                .send(
                    ...
                    "service_3an9dnu",       // Service ID
                    "template_z0nxqxm",     // Template ID
                    templateParams,
                    "sRcEZ27jWrnqzDM2N"     // User ID
                )
                .then((response) => {
                ...
                .catch((error) => {
                    console.error("Failed to send...", error); // Detailed error log
    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <div className="p-4 lg:w-3/4" id="contact">
                <Toaster />
                <h2 className="my-8 text-center text-4xl font-semibold tracking-tighter">Let's Contact</h2>
